...
const INIT_DB_FILE4 = path.join(__dirname, './comment.sql')
...
console.log(`准备读取 SQL 文件：${INIT_DB_FILE4}`)
...
const content4 = fs.readFileSync(INIT_DB_FILE4, 'utf8')
